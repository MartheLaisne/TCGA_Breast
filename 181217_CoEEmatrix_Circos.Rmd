...
---
Ce notebook décrit comment explorer l'expression des 73 selected CT à travers les différents sous-types de Breast tumeurs. Il aboutit à la génération de matrices de corrélation des CT entre eux, de circos plot pour représenter ces corrélations. On en tire aussi le calcul des fréquence d'espression (Pour chaque selected CT, #ON / #tous), sa représentation en heatmap et les boxplot par sous-type.
